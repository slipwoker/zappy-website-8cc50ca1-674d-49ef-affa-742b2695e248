document.addEventListener('DOMContentLoaded', function() {
            ...
            if (isValid) {
                ...
                if (submitButton) {
                    ...
                    setTimeout(function() {
                        ...
                        successMessage.style.cssText = 'color: #28a745; margin-top: 1rem; padding: 0.75rem; background: #d4edda; border-radius: 4px;';
    ...
    if (animatedElements.length > 0) {
        ...
        animatedElements.forEach(function(element) {
            ...
            if (element.classList.contains('fade-in-up') || element.dataset.animate === 'fade-in-up') {
                element.style.transform = 'translateY(30px)';
            } else if (element.classList.contains('fade-in-left') || element.dataset.animate === 'fade-in-left') {
                element.style.transform = 'translateX(-30px)';
            } else if (element.classList.contains('fade-in-right') || element.dataset.animate === 'fade-in-right') {
                element.style.transform = 'translateX(30px)';
            }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '8cc50ca1-674d-49ef-affa-742b2695e248',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '8cc50ca1-674d-49ef-affa-742b2695e248';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '8cc50ca1-674d-49ef-affa-742b2695e248';
